...
| ttScore | 0.9.5 | automatic Live controller, transition/finalization stabilization, rejected pause removal, prototype-state simplification |
| ttscore_team | 0.12.0 | unchanged from accepted Release-2 baseline |

Current dependency closure:

- `index.html` = `ttscore_0.9.5.html` byte-for-byte;
