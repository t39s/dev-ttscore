...
const source = readFileSync(new URL('../../ttscore_0.5.1.html', import.meta.url), 'utf8');
...
test('версия 0.5.1 объявлена, но локальный protocol namespace 0.3.5 сохранён', () => {
  assert.match(source, /<title>ttScore 0\.5\.1<\/title>/);
  assert.match(source, /Версия 0\.5\.1/);
