...
} from "../../team/assets/0.11.1/firebase-source.mjs";
import { createTeamMatch } from "../../team/assets/0.11.1/creator.mjs";
import { prepareEditableSource, sourceRevision } from "../../team/assets/0.11.1/editor.mjs";

const source = readFileSync(new URL("../../team/assets/0.11.1/firebase-source.mjs", import.meta.url), "utf8");
