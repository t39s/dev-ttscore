...
} from '../../team/assets/0.11.1/team-integration-contract.mjs';
...
test('finish transition публикует reportUrl атомарно с результатом', () => {
  const source = raw(); const a = teamAssignment(source); const state = scoreState(a); const b = bindAssignment(a, state);
  const reportUrl = 'https://example.invalid/ttscore_0.5.1.html?page=report&source=team&teamMatch=team-contract&record=2026-0905-abcd';
